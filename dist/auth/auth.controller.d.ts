...
export declare class AuthController {
    ...
    profileInfo(req: Request): Promise<{
    ...
    profileUpdate(req: Request, updateDto: ProfileUpdateDto): Promise<import("mongoose").Document<unknown, {}, import("./schemas/profile.schema").Profile> & import("./schemas/profile.schema").Profile & {
        _id: import("mongoose").Types.ObjectId;
    }>;
}
