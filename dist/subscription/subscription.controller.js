...
let SubscriptionController = exports.SubscriptionController = class SubscriptionController {
    ...
    async stripeWebhook(stripeSignature, request) {
        return this.subscriptionService.handleStripeWebhook(request.rawBody, stripeSignature);
    }
};
__decorate([
    (0, common_1.Get)('subscription/all'),
