  ...
  async handleStripeWebhook(requestBody, signature) {
    ...
    try {
      event = stripe.webhooks.constructEvent(
        requestBody,
        signature,
        this.configService.get('STRIPE_WEBHOOK_SECRECT_PROD'),
      );
      ...
      if (event.type === 'checkout.session.completed') {
        ...
        await this.profileModel.findOneAndUpdate(
          ...
          {
            notesAllowed: (0, plans_1.getNotesBasedOnPlan)(
      ...
      if (event.type === 'customer.subscription.deleted') {
        ...
        await this.profileModel.findOneAndUpdate(
          ...
          {
            notesAllowed: (0, plans_1.getNotesBasedOnPlan)(
              plans_1.SubscriptionPlans.FREE,
            ),
          },
        );
      }
  ...
  [
    ...
    __param(
      ...
      (0, mongoose_1.InjectModel)(
        subscription_plan_schema_1.SubscriptionPlan.name,
      ),
    ),
